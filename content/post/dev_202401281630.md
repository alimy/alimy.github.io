...
title = "Kitex: Thrift-HTTP 映射的 IDL 规范"
tags = [
    "development",
    "Kitex",
    "Microservice",    
]
date = "2024-01-28T16:30:00+08:00"
categories = [
    "Development",
]
menu = "Development"
...
（备注: 转载自[网络](https://www.cloudwego.io/zh/docs/kitex/tutorials/advanced-feature/generic-call/thrift_idl_annotation_standards/ 'Thrift-HTTP 映射的 IDL 规范')）
