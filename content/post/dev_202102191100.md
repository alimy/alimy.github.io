...
title = "Memcached - Basic Text Protocol"
tags = [
    "development",
	"cache",
    "memcached",
...
Full documentation can be found in the [Protocol Documentation](https://docs.memcached.org/protocols/).
...
本文转载自[网络](https://docs.memcached.org/protocols/basic/ 'Basic Text Protocol').
