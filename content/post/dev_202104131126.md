...
%> openssl req -new -x509 -days 3650 \
     -subj "/C=China/L=Shanghai/O=grpc/CN=grpc.me"
...
# 未使用CA签名的server.crt
%> openssl req -new -x509 -days 3650 \
     -subj "/C=China/L=Shanghai/O=grpc-server/CN=server.grpc.me" \
...
# 未使用CA签名的client.crt
%> openssl req -new -x509 -days 3650 \
     -subj "/C=China/L=Shanghai/O=grpc-client/CN=client.grpc.me" \
